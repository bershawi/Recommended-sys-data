...
# print(ratings['num of rating'].head())
# ratings['num of rating'].hist(bins=70)
# ratings['rating'].hist(bins=80)
# sns.jointplot(x='rating',y='num of ratings',data=ratings,alpha=0.5,color='navy')
# plt.show()
...
print(corr_liarliar[corr_liarliar['num of ratings']>100].sort_values('Correlation',ascending=False).head(903))